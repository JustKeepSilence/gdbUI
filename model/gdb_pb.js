...
goog.exportSymbol('proto.model.CalcItemInfo', null, global);
...
goog.exportSymbol('proto.model.HistoricalItemValue', null, global);
goog.exportSymbol('proto.model.HistoryFileInfo', null, global);
goog.exportSymbol('proto.model.ItemValue', null, global);
goog.exportSymbol('proto.model.ItemsInfo', null, global);
goog.exportSymbol('proto.model.LogInfo', null, global);
 ...
 * @constructor
 */
proto.model.ItemValue = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.model.ItemValue, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.ItemValue.displayName = 'proto.model.ItemValue';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.model.BatchWriteString = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.model.BatchWriteString.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.model.HistoricalItemValue = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.model.HistoricalItemValue.repeatedFields_, null);
};
goog.inherits(proto.model.HistoricalItemValue, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.HistoricalItemValue.displayName = 'proto.model.HistoricalItemValue';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.model.BatchWriteHistoricalString = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.model.BatchWriteHistoricalString.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.model.LogInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.model.LogInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.LogInfo.displayName = 'proto.model.LogInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.model.LogsInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.model.LogsInfo.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.model.CalcItemInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.model.CalcItemInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.CalcItemInfo.displayName = 'proto.model.CalcItemInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.model.CalcItemsInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.model.CalcItemsInfo.repeatedFields_, null);
};
 ...
 * @return {!Object}
 */
proto.model.ItemValue.prototype.toObject = function(opt_includeInstance) {
  return proto.model.ItemValue.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.ItemValue} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.ItemValue.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.ItemValue}
 */
proto.model.ItemValue.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.ItemValue;
  return proto.model.ItemValue.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.ItemValue} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.ItemValue}
 */
proto.model.ItemValue.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.ItemValue.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.ItemValue.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.ItemValue} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.ItemValue.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.model.ItemValue.prototype.getItemname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.model.ItemValue} returns this
 */
proto.model.ItemValue.prototype.setItemname = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.model.ItemValue.prototype.getValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.model.ItemValue} returns this
 */
proto.model.ItemValue.prototype.setValue = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.model.ItemValue.prototype.getTimestamp = function() {
 ...
 * @return {!proto.model.ItemValue} returns this
 */
proto.model.ItemValue.prototype.setTimestamp = function(value) {
 ...
 * @const
 */
proto.model.BatchWriteString.repeatedFields_ = [3];
...
proto.model.BatchWriteString.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemvaluesList: jspb.Message.toObjectList(msg.getItemvaluesList(),
    proto.model.ItemValue.toObject, includeInstance)
  };
...
proto.model.BatchWriteString.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 3:
      var value = new proto.model.ItemValue;
      reader.readMessage(value,proto.model.ItemValue.deserializeBinaryFromReader);
      msg.addItemvalues(value);
      break;
    default:
      reader.skipField();
...
proto.model.BatchWriteString.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.model.ItemValue.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.model.ItemValue>}
 */
proto.model.BatchWriteString.prototype.getItemvaluesList = function() {
  return /** @type{!Array<!proto.model.ItemValue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.model.ItemValue, 3));
};


/**
 * @param {!Array<!proto.model.ItemValue>} value
 * @return {!proto.model.BatchWriteString} returns this
*/
proto.model.BatchWriteString.prototype.setItemvaluesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};


/**
 * @param {!proto.model.ItemValue=} opt_value
 * @param {number=} opt_index
 * @return {!proto.model.ItemValue}
 */
proto.model.BatchWriteString.prototype.addItemvalues = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.model.ItemValue, opt_index);
};
 ...
 * @return {!proto.model.BatchWriteString} returns this
 */
proto.model.BatchWriteString.prototype.clearItemvaluesList = function() {
  return this.setItemvaluesList([]);
};
 ...
 * @const
 */
proto.model.QueryRealTimeDataString.repeatedFields_ = [1];
 ...
 * @const
 */
proto.model.QueryHistoricalDataString.repeatedFields_ = [1,2,3,4];
 ...
 * @const
 */
proto.model.QueryHistoricalDataWithTimeStampString.repeatedFields_ = [1,2];
 ...
 * @const
 */
proto.model.QueryHistoricalDataWithConditionString.repeatedFields_ = [1,2,3,4,5,7];
 ...
 * @const
 */
proto.model.HistoricalItemValue.repeatedFields_ = [2,3];
 ...
 * @return {!Object}
 */
proto.model.HistoricalItemValue.prototype.toObject = function(opt_includeInstance) {
  return proto.model.HistoricalItemValue.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.HistoricalItemValue} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.HistoricalItemValue.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemname: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.HistoricalItemValue}
 */
proto.model.HistoricalItemValue.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.HistoricalItemValue;
  return proto.model.HistoricalItemValue.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.HistoricalItemValue} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.HistoricalItemValue}
 */
proto.model.HistoricalItemValue.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.HistoricalItemValue.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.HistoricalItemValue.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.HistoricalItemValue} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.HistoricalItemValue.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getItemname();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.model.HistoricalItemValue.prototype.getItemname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.model.HistoricalItemValue} returns this
 */
proto.model.HistoricalItemValue.prototype.setItemname = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<string>}
 */
proto.model.HistoricalItemValue.prototype.getValuesList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 2));
};
 ...
 * @return {!proto.model.HistoricalItemValue} returns this
 */
proto.model.HistoricalItemValue.prototype.setValuesList = function(value) {
  return jspb.Message.setField(this, 2, value || []);
};
 ...
 * @return {!proto.model.HistoricalItemValue} returns this
 */
proto.model.HistoricalItemValue.prototype.addValues = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
};
 ...
 * @return {!proto.model.HistoricalItemValue} returns this
 */
proto.model.HistoricalItemValue.prototype.clearValuesList = function() {
 ...
 * @return {!Array<string>}
 */
proto.model.HistoricalItemValue.prototype.getTimestampsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 3));
};
 ...
 * @return {!proto.model.HistoricalItemValue} returns this
 */
proto.model.HistoricalItemValue.prototype.setTimestampsList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.model.HistoricalItemValue} returns this
 */
proto.model.HistoricalItemValue.prototype.addTimestamps = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
 ...
 * @return {!proto.model.HistoricalItemValue} returns this
 */
proto.model.HistoricalItemValue.prototype.clearTimestampsList = function() {
  return this.setTimestampsList([]);
};
 ...
 * @const
 */
proto.model.BatchWriteHistoricalString.repeatedFields_ = [1];
...
proto.model.BatchWriteHistoricalString.toObject = function(includeInstance, msg) {
  var f, obj = {
    historicalitemvaluesList: jspb.Message.toObjectList(msg.getHistoricalitemvaluesList(),
    proto.model.HistoricalItemValue.toObject, includeInstance)
  };
...
proto.model.BatchWriteHistoricalString.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.model.HistoricalItemValue;
      reader.readMessage(value,proto.model.HistoricalItemValue.deserializeBinaryFromReader);
      msg.addHistoricalitemvalues(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.model.BatchWriteHistoricalString.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getHistoricalitemvaluesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.model.HistoricalItemValue.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.model.HistoricalItemValue>}
 */
proto.model.BatchWriteHistoricalString.prototype.getHistoricalitemvaluesList = function() {
  return /** @type{!Array<!proto.model.HistoricalItemValue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.model.HistoricalItemValue, 1));
};


/**
 * @param {!Array<!proto.model.HistoricalItemValue>} value
 * @return {!proto.model.BatchWriteHistoricalString} returns this
*/
proto.model.BatchWriteHistoricalString.prototype.setHistoricalitemvaluesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.model.HistoricalItemValue=} opt_value
 * @param {number=} opt_index
 * @return {!proto.model.HistoricalItemValue}
 */
proto.model.BatchWriteHistoricalString.prototype.addHistoricalitemvalues = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.model.HistoricalItemValue, opt_index);
};
 ...
 * @return {!proto.model.BatchWriteHistoricalString} returns this
 */
proto.model.BatchWriteHistoricalString.prototype.clearHistoricalitemvaluesList = function() {
  return this.setHistoricalitemvaluesList([]);
};
 ...
 * @const
 */
proto.model.QuerySpeedHistoryDataString.repeatedFields_ = [2,3];
 ...
 * @return {number}
 */
proto.model.QuerySpeedHistoryDataString.prototype.getInterval = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.model.QuerySpeedHistoryDataString} returns this
 */
proto.model.QuerySpeedHistoryDataString.prototype.setInterval = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};
...
proto.model.UserInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    username: (f = msg.getUsername()) && proto.model.UserName.toObject(includeInstance, f),
...
proto.model.UserInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.model.UserName;
      reader.readMessage(value,proto.model.UserName.deserializeBinaryFromReader);
      msg.setUsername(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
...
proto.model.UserInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.model.UserName.serializeBinaryToWriter
    );
  }
...
/**
 * optional UserName userName = 1;
 * @return {?proto.model.UserName}
 */
proto.model.UserInfo.prototype.getUsername = function() {
  return /** @type{?proto.model.UserName} */ (
    jspb.Message.getWrapperField(this, proto.model.UserName, 1));
};


/**
 * @param {?proto.model.UserName|undefined} value
 ...
 * @return {!proto.model.UserInfo} returns this
 */
proto.model.UserInfo.prototype.clearUsername = function() {
 ...
 * @return {boolean}
 */
proto.model.UserInfo.prototype.hasUsername = function() {
 ...
 * @return {string}
 */
proto.model.QueryLogsInfo.prototype.getLogtype = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.model.QueryLogsInfo.prototype.setLogtype = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.model.QueryLogsInfo.prototype.getCondition = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.model.QueryLogsInfo} returns this
 */
proto.model.QueryLogsInfo.prototype.setCondition = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.model.LogInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.model.LogInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.LogInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.LogInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.LogInfo}
 */
proto.model.LogInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.LogInfo;
  return proto.model.LogInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.LogInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.LogInfo}
 */
proto.model.LogInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.LogInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.LogInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.LogInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.LogInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.model.LogInfo.prototype.getInfoMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      null));
};
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.model.LogInfo} returns this
 */
proto.model.LogInfo.prototype.clearInfoMap = function() {
 ...
 * @const
 */
proto.model.LogsInfo.repeatedFields_ = [2];
...
proto.model.LogsInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    infosList: jspb.Message.toObjectList(msg.getInfosList(),
    proto.model.LogInfo.toObject, includeInstance)
  };
...
proto.model.LogsInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 2:
      var value = new proto.model.LogInfo;
      reader.readMessage(value,proto.model.LogInfo.deserializeBinaryFromReader);
      msg.addInfos(value);
      break;
    default:
      reader.skipField();
...
proto.model.LogsInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.model.LogInfo.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.model.LogInfo>}
 */
proto.model.LogsInfo.prototype.getInfosList = function() {
  return /** @type{!Array<!proto.model.LogInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.model.LogInfo, 2));
};


/**
 * @param {!Array<!proto.model.LogInfo>} value
 * @return {!proto.model.LogsInfo} returns this
*/
proto.model.LogsInfo.prototype.setInfosList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.model.LogInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.model.LogInfo}
 */
proto.model.LogsInfo.prototype.addInfos = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.model.LogInfo, opt_index);
};
 ...
 * @return {!proto.model.LogsInfo} returns this
 */
proto.model.LogsInfo.prototype.clearInfosList = function() {
  return this.setInfosList([]);
};
 ...
 * @return {number}
 */
proto.model.UpdatedUserInfo.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.model.UpdatedUserInfo.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional string oldUserName = 2;
 * @return {string}
 */
proto.model.UpdatedUserInfo.prototype.getOldusername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.model.UpdatedUserInfo} returns this
 */
proto.model.UpdatedUserInfo.prototype.setOldusername = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional string newUserName = 3;
 * @return {string}
 */
 ...
 * @return {string}
 */
proto.model.UpdatedUserInfo.prototype.getRole = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.model.UpdatedUserInfo} returns this
 */
proto.model.UpdatedUserInfo.prototype.setRole = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {!Object}
 */
proto.model.CalcItemInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.model.CalcItemInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.CalcItemInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.CalcItemInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    infoMap: (f = msg.getInfoMap()) ? f.toObject(includeInstance, undefined) : []
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.CalcItemInfo}
 */
proto.model.CalcItemInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.CalcItemInfo;
  return proto.model.CalcItemInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.CalcItemInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.CalcItemInfo}
 */
proto.model.CalcItemInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.CalcItemInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.CalcItemInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.CalcItemInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.CalcItemInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getInfoMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeString);
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.model.CalcItemInfo.prototype.getInfoMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      null));
};
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.model.CalcItemInfo} returns this
 */
proto.model.CalcItemInfo.prototype.clearInfoMap = function() {
  this.getInfoMap().clear();
  return this;};
 ...
 * @const
 */
proto.model.CalcItemsInfo.repeatedFields_ = [2];
...
proto.model.CalcItemsInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    infosList: jspb.Message.toObjectList(msg.getInfosList(),
    proto.model.CalcItemInfo.toObject, includeInstance)
  };
...
proto.model.CalcItemsInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 2:
      var value = new proto.model.CalcItemInfo;
      reader.readMessage(value,proto.model.CalcItemInfo.deserializeBinaryFromReader);
      msg.addInfos(value);
      break;
    default:
      reader.skipField();
...
proto.model.CalcItemsInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.model.CalcItemInfo.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.model.CalcItemInfo>}
 */
proto.model.CalcItemsInfo.prototype.getInfosList = function() {
  return /** @type{!Array<!proto.model.CalcItemInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.model.CalcItemInfo, 2));
};


/**
 * @param {!Array<!proto.model.CalcItemInfo>} value
 * @return {!proto.model.CalcItemsInfo} returns this
*/
proto.model.CalcItemsInfo.prototype.setInfosList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.model.CalcItemInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.model.CalcItemInfo}
 */
proto.model.CalcItemsInfo.prototype.addInfos = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.model.CalcItemInfo, opt_index);
};
 ...
 * @return {!proto.model.CalcItemsInfo} returns this
 */
proto.model.CalcItemsInfo.prototype.clearInfosList = function() {
  return this.setInfosList([]);
};
